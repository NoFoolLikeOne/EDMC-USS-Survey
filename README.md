...
# Installation
Download the [latest release](https://github.com/NoFoolLikeOne/EDMC-USS-Survey/releases/download/3_0b/EDMC-USS-Survey-3.0b.zip), open the archive (zip) and extract the folder  to your EDMC plugin folder.
