...
# Installation
Download the [latest release](https://github.com/NoFoolLikeOne/EDMC-USS-Survey/releases/download/3.0b2/EDMC-USS-Survey-3.0b2.zip), open the archive (zip) and extract the folder  to your EDMC plugin folder.
