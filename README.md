...
# Installation
Download the [latest release](https://github.com/NoFoolLikeOne/EDMC-USS-Survey/archive/2_2.zip), open the archive (zip) and extract the folder  to your EDMC plugin folder.
